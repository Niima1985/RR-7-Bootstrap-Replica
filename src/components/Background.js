...
export default function Background() {
    return (
        <div>
            <Card style={{ width: "100%", minHeight: "428px" }} >
            <Card.Img style={{ height: "100%", width: "100%", position: "relative", top:"auto"}} src="https://www.instacart.com/assets/homepage-hero-background-ec75de0ea80198801094497b46ad920b.jpg" alt="Card image" />
                <Card.ImgOverlay style={{ top: "auto", width: "578px", marginLeft: "100px", marginBottom: "100px"}}>
